...
export default function Home() {
  ...
  /* keep filtered products in sync with Redux items */
  useEffect(() => {
  ...
  /* final filtered products (search + category) */
  const filteredProducts = productFilter.filter((item) =>
    searchTerm === ""
      ? true
          ...
          <div className="mx-auto max-w-screen-xl">
            ...
            <form className="flex justify-center ml-2">
              <select
                ...
                className="min-[676px]:hidden bg-gray-50 font-medium border border-gray-300 outline-none text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-44 p-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
              >
                <option value="all">{t("All Products")}</option>
                <option value="Phones">{t("Phones & Tablets")}</option>
              ...
              <div className="relative w-full ml-4 rounded-lg">
                <input
                  ...
                  className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg outline-blue-600 border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                />
                <button
                  type="button"
                  aria-label="Search"
                ...
                >
                  <BsSearch className="text-blue-400 w-6 h-6" />
                </button>
              </div>
            </form>
            ...
            {/* Show Data Products */}
            <div className="mt-6 ml-56 max-[676px]:ml-3 grid grid-cols-3 gap-2 md:grid-cols-4 sm:grid-cols-3 lg:mt-6 lg:grid-cols-5">

        ...
        <div className="mx-auto flex w-full max-w-xl lg:max-w-screen-xl">
          <div className="mb-16 lg:my-auto lg:max-w-lg">
            <div className="mb-6 max-w-xl">
              <div>
                <p className="mb-2 inline-block rounded-full bg-lime-300 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-indigo-900">
                  25% off this summer
                </p>
              </div>
              <h2 className="mb-6 max-w-lg text-3xl font-extrabold text-slate-700 sm:text-5xl sm:leading-snug">
                ...
                <br />
                {t("promo1")}{" "}
                <span className="inline-block rounded bg-gradient-to-r from-lime-400 to-sky-400 px-2 font-bold text-white">
                  {t("promo2")}
                </span>
              </h2>
              <p className="text-base text-gray-700 md:text-lg">{t("para")}</p>
            </div>
            <div className="flex items-center">
              <button
                onClick={() => navigate("/Login")}
                className="mr-6 inline-flex h-12 items-center justify-center rounded-full bg-gradient-to-r from-blue-400 to-sky-400 px-8 font-medium tracking-wide text-white shadow-lg shadow-sky-300 transition duration-200 hover:scale-110 hover:from-blue-500 hover:to-sky-500 focus:ring"
              >
                Get started
              </button>
